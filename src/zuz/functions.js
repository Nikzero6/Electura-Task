...
class ZuzToast {
    constructor() {
        ...
        const _Toast = (options) => {
            var tout = null, ID = 'zuz-toast-' + generateID(5, 4), toast = document.createElement('div'), btn = document.createElement('button');
        ...
        self.arrangeToasts = (callback) => {
            var toasts = document.querySelectorAll(".zuz-toast"), bottom = 20, i = toasts.length;
            while (i--) {
